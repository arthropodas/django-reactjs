...
from .views import  CustomTokenRefreshView, AdminDashboardData, AddListFeedback, DropDownLists, AdminLoginAPIView,AdminViewFeedback,DropDownListsStudent,BarGraphInstitutionStudent,ExamAndQuestionnaireAnalysis,ExamAnalytics
...
urlpatterns = [
    ...
    path('admin/bar-graph-data',BarGraphInstitutionStudent.as_view(), name='bar-graph'),
    path('admin/exams-questionnaire-analysis',ExamAndQuestionnaireAnalysis.as_view(), name='exam-questionnaire_analysis'),
    path('admin/exam-analytics',ExamAnalytics.as_view(),name='exam_analytics')
