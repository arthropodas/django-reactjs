...
const adminQuestionnaireErrorCodes = (errorCode) => {
    let errorMessage = "";
    ...
    switch (errorCode) {
        ...
        case "e3004":
            ...
            break;
        case "e3005":
            errorMessage = "No questions found for the category";
            break;
        case "e3006":
        ...
        case "e3008":
            ...
            break;
        case "e3009":
            errorMessage = "No Questions exist";
            break;
        case "e3011":
        ...
        case "e3206":
            ...
            break;
        case "e3207":
            errorMessage = "Exactly 2 options required for this question type";
            break;
        case "e3300":
        ...
        case "e3302":
            ...
            break;
        case "e3304":
            errorMessage = "Answer list cannot be empty";
            break;

        case "e3305":
            errorMessage = "Only one correct answer is allowed";
            break;
        case "e4203":
        ...
        case "e3500":
            ...
            break;
        case "e3501":
            errorMessage = "Question type cannot be empty";
            break;
        case "e3504":
            errorMessage = "Duplicate answers found";
            break;
        case "e4101":
            errorMessage = "Question difficulty level cannot be empty";
            break;

        case "e4202":
            errorMessage = "File should be less than 2mb";
            break;
        case "e2201":
...
export default adminQuestionnaireErrorCodes;