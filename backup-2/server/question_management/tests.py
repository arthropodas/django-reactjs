...
from .models import QuestionData, Options
import json
...
class QuestionAddViewTestCase(TestCase):
    def setUp(self):
        ...
        self.duplicate_options = {
            ...
            "question_type": 0,
            "category_id": "100",
            "wrong_options": '["Lyon","Marseille","Lyon"]',
        }

        self.options = json.dumps(["Marseille", "Lyon" * 101, "Bordeaux"])

        self.invalid_correct_answer = json.dumps(["p" * 101])

        self.invalid_options_length = {
            "question": "What is the capital of France?",
            "question_type": 0,
            "category_id": "100",
            "wrong_options": self.options,
        }
        ...
        self.invalid_option_type_length = {
            ...
            "question_type": 1,
            "category_id": "100",
            "wrong_options": '["Marseille","Bordeaux","Lyon",100000]',
        }
        ...
        self.correct_answer_required = {
            ...
            "question_type": 0,
            "category_id": 1,
            "wrong_options": json.dumps(["Lyon", "Marseille", "Toulouse"]),
        }
        ...
        self.correct_answer_min_with_question_type = {
            ...
            "question_type": 0,
            "category_id": 1,
            "wrong_options": '["black","gray","white"]',
            "correct_answer": '["black","gray"]',
        }
    ...
    def test_minimum_options_required(self):
        ...
        response = self.view(request)
        response.render()
        print("response999999999999999999999999999999", response.content)
        self.assertEqual(response.status_code, status.HTTP_400_BAD_REQUEST)
...
class QuestionListViewTestCase(TestCase):
    def setUp(self):
        ...
        self.question_data_not_found = QuestionData.objects.create(
            question="What is the capital of France?",
            question_category_id=self.question_category,
            status=0,
        )
...
class QuestionUpdateViewTestCase(TestCase):
    def setUp(self):
        ...
        self.valid_option_update = json.dumps([2, 4, 7, 11])
        self.admin = Admin.objects.create(
            id=1, email="test@gmail.com", password="test@password.com", status=True
        )
        self.question_data = QuestionData.objects.create(
        ...
        Options.objects.create(
            question_id=self.question_data, option=self.valid_options
        )

        Options.objects.create(
            question_id=self.question_data2, option=json.dumps([2, 4, 7, 9])
        )

        Options.objects.create(
            option="paris", question_id=self.question_data, is_correct=1
        )

        Options.objects.create(
            option="new", question_id=self.question_data2, is_correct=1
        )
        self.image_content = b"Image content here"
        self.valid_image = SimpleUploadedFile(
        ...
        self.valid_image2 = SimpleUploadedFile(
            "test2_image.png", self.image_content, content_type="image/png"
        )
        ...
        self.valid_payload = {
            "question": "Is Titanic was released in 1999",
            "question_type": 1,
            "category_id": self.question_category.id,
        ...
        self.valid_payload2 = {
            ...
            "question_type": 2,
            "category_id": self.question_category.id,
            "options": json.dumps([2, 4, 7]),
            "correct_answer": json.dumps(["delhi", "canada"]),
            "question_image": self.valid_image2,
        }
        ...
        self.invalid_data_payload = {
            ...
            "question_type": 1,
            "category_id": self.question_category.id,
            "options": json.dumps([2, 4, 11]),
            "correct_answer": json.dumps([2]),
            "question_image": self.valid_image,
        }
    ...
    def test_valid_question_update(self):
        ...
        self.assertEqual(
            response.data["option_updated"], "Option updated successfully."
        )
...
class QuestionCsvUploadTestCaseView(TestCase):
    ...
    def test_valid_csv_upload(self):
        ...
        csv_content = (
            "Question,Question_type,Category,Difficulty_level,Option_1,Option_2,Option_3,Answer_1,Answer_2,Answer_3\n"
            f"What is the capital of France?,multiple choice,{self.question_category.question_category_name},medium,Easy,Paris,London,Berlin\n"
        )
    ...
    def test_invalid_csv_data(self):
        ...
        response = self.view(request)
        response.render()
        print("rtthwvehvfhwevhf", response.content)
        self.assertEqual(response.status_code, status.HTTP_400_BAD_REQUEST)
