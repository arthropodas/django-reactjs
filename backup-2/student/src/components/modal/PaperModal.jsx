...
function PaperModal({ open, onClose, children, handleClose, width, height, showCloseButton }) {
  ...
  return (
    ...
    >
      ...
      >
      {showCloseButton && <ModalCloseButton title="close" />}
        {children}
      </ModalContent>
    </Modal>
  );
...
PaperModal.propTypes = {
  ...
  showCloseButton: PropTypes.bool,  // Add showCloseButton prop
};
